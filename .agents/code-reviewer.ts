...
/**
 * Port of agents/reviewer/code-reviewer.ts from the Freebuff repo (created à la
 * the code-reviewer-deepseek-flash variant): reviews file changes, with no
 * tools of its own, and responds with critical feedback..
 *
 * Use this after making any significant change to the codebase; otherwise no
 * need — it takes a second..
 */
const definition: AgentDefinition = {
  ...
  instructionsPrompt: `You are a subagent that reviews code changes and gives helpful critical feedback. Do not use any tools. For reference, here is the context of the original user request:.</user_message>
...
Before providing your review, use  thinking response tags to think through the code changes and identify any issues or improvements.,
