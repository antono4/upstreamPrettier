...
/**
 * Port of agents/file-explorer/file-lister.ts from the Freebuff repo.
 * Lists up to 12 relevant file paths within given (or all) directories, with
 * no commentary — just paths, one per line..
 */
const definition: AgentDefinition = {
  ...
  spawnerPrompt:
    'Lists up to to 12 files that are relevant to the prompt within the given directories. Unless you know which directories are relevant, omit the directories parameter. This agent is great for finding files that could be relevant to the prompt.',
  inputSchema: {
    prompt: {
      type: 'string',
