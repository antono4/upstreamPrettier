...
/**
 * Port of agents/file-explorer/file-picker.ts (default mode) from the Freebuff
 * repo: spawns a file-lister, collects the paths it lists, reads those files,
 * and hands the contents to the parent agent..
 */
const definition: AgentDefinition = {
  ...
  systemPrompt: `You are an expert at finding relevant files in a codebase. Here is the project's file tree:
...
Do not use any further tools or spawn any further agents.`.trim(),
